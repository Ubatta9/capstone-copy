...
it('should dispatch SHOW_ADD_EDIT_PROCESS when Add process button is clicked',() =>{
    ...
    render(<EditorHome _useSelector = {() =>{}} _useDispatch ={() => dispatch}
                       _initiateEditor ={initEditor} _AddEditProcess={()=>{}} _AllProcesses ={()=>{}} _initiateFinishedProcessFollowings = {initFinish}/>)
